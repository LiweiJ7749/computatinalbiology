...
#SBATCH --gres=gpu:1
#SBATCH --time=2:00:00
#SBATCH -o dlpfc509_gpu.%j.out
#SBATCH -e dlpfc509_gpu.%j.err

# DLPFC_151509（4226 spot）：SpaGCN + SpaSEG（GPU，复用 cpu 作业的前处理）
